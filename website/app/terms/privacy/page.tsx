    ...
    <div className="section-shell py-16 sm:py-20">
      <div className="max-w-3xl">
        ...
        <p className="mt-5 text-lg leading-8 text-slate-600">
          Ben Yaparim, kullanicilarina guvenli ve seffaf bir deneyim sunabilmek icin gerekli
          verileri isler. Hangi bilginin neden kullanildigini acikca anlatmayi ve topluluk
          guvenligini korumayi onemsiyoruz.
        </p>
      </div>
      ...
      <div className="mt-8 rounded-4xl border border-plum-100 bg-white p-6">
        ...
        <p className="mt-3 text-sm leading-7 text-slate-600">
          Gizlilik, veri talepleri, sikayetler veya hesap silme surecleriyle ilgili her konuda{" "}
